"""
Django settings for skill_sync project.
"""
...
WSGI_APPLICATION = 'skill_sync.wsgi.application'
...
# If DATABASE_URL is provided, use it (e.g., Postgres in production)
